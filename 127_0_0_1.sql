...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2018-03-03 00:58:50
-- 服务器版本： 5.7.19
-- PHP Version: 5.6.31
...
-- Database: `flowerapp`
--
CREATE DATABASE IF NOT EXISTS `flowerapp` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `flowerapp`;
...
CREATE TABLE IF NOT EXISTS `adress` (
  ...
  `ad_name` varchar(255) NOT NULL COMMENT '收货人姓名',
  `ad_tel` varchar(255) NOT NULL COMMENT '收货人电话',
  `ad_city` varchar(255) NOT NULL COMMENT '省市区街道',
  `ad_adress` varchar(255) NOT NULL COMMENT '详细地址',
...
CREATE TABLE IF NOT EXISTS `comments` (
  `mid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '评论ID',
  `uid` int(10) NOT NULL COMMENT '用户ID',
  `gid` int(10) NOT NULL COMMENT '商品ID',
  `mcontent` varchar(255) NOT NULL COMMENT '评论内容',
  `mdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '评论时间',
  `msatisfaction` int(10) NOT NULL COMMENT '满意度',
  `mpicture` varchar(800) NOT NULL DEFAULT '0' COMMENT '评论图片',
  PRIMARY KEY (`mid`)
...
CREATE TABLE IF NOT EXISTS `f_article` (
  ...
  `fname` varchar(255) NOT NULL COMMENT '中文标题',
  `fenname` varchar(255) NOT NULL COMMENT '英文标题',
  `fdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '发表时间',
  `fcontent` varchar(2000) NOT NULL COMMENT '内容',
  PRIMARY KEY (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='花言花语';
...
CREATE TABLE IF NOT EXISTS `goods` (
  ...
  PRIMARY KEY (`gid`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='商品';
...
(3, '粉玫瑰', 'fenmeigui', '这是描述1^这是描述二', '/flowerApp/static/upload/18-03-02/151996086879.png,/flowerApp/static/upload/18-03-02/1519960868152.png', '/flowerApp/static/upload/18-03-02/151996083272.png', '/flowerApp/static/upload/18-03-02/151996085758.png,/flowerApp/static/upload/18-03-02/151996085763.png', '99,199,999', '/flowerApp/static/upload/18-03-02/1519960840136.png', 6, 199, 0),
(4, '白玫瑰', 'baimeigui', '详情1^详情2', '/flowerApp/static/upload/18-03-02/151996101114.png,/flowerApp/static/upload/18-03-02/151996101176.png', '/flowerApp/static/upload/18-03-02/151996099175.png', '', '12,521,1314', '/flowerApp/static/upload/18-03-02/1519960997166.png', 6, 99, 0),
(5, '白玫瑰', 'baimeigui', '详情1^详情2', '/flowerApp/static/upload/18-03-02/151996101114.png,/flowerApp/static/upload/18-03-02/151996101176.png', '/flowerApp/static/upload/18-03-02/151996099175.png', '', '12,521,1314', '/flowerApp/static/upload/18-03-02/1519960997166.png', 6, 99, 0);
...
CREATE TABLE IF NOT EXISTS `index_user` (
  ...
  `upicture` varchar(255) NOT NULL DEFAULT '/flowerApp/static/image/wsimg/55b9130c120d66ecf352b7c65de7fc99.jpg' COMMENT '用户头像，有默认',
  `unickname` varchar(255) NOT NULL DEFAULT 'unickname' COMMENT '昵称',
  `ubirthday` varchar(255) NOT NULL DEFAULT '19990101' COMMENT '生日',
  `usex` varchar(255) NOT NULL DEFAULT '未定义' COMMENT '性别',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户注册';

--
-- 转存表中的数据 `index_user`
--

INSERT INTO `index_user` (`uid`, `username`, `password`, `utel`, `upicture`, `unickname`, `ubirthday`, `usex`) VALUES
(1, 'deng123', 'f379eaf3c831b04de153469d1bec345e', '13636705210', '/flowerApp/static/image/wsimg/55b9130c120d66ecf352b7c65de7fc99.jpg', 'unickname', '19990101', ''),
(2, 'dengpeng', 'f379eaf3c831b04de153469d1bec345e', '13636705210', '/flowerApp/static/image/wsimg/55b9130c120d66ecf352b7c65de7fc99.jpg', 'A。Flowers', '19940202', '男');
...
CREATE TABLE IF NOT EXISTS `orderlist` (
  ...
  `ostatus` varchar(255) DEFAULT '0' COMMENT '订单状态0:未付款,1已付款,2已发货,3已完成',
  `onum` int(48) NOT NULL COMMENT '订单号',
  `ototalPrice` varchar(255) NOT NULL COMMENT '订单总价',
  PRIMARY KEY (`oid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
INSERT INTO `orderlist` (`oid`, `uid`, `odate`, `ostatus`, `onum`, `ototalPrice`) VALUES
(1, 2, '2018-03-02 06:57:24', '0', 1519973844, '199'),
(2, 2, '2018-03-02 06:57:42', '0', 1519973862, '199'),
(3, 2, '2018-03-02 07:03:23', '0', 1519974203, '199');
...
--
-- 转存表中的数据 `order_attach`
--

INSERT INTO `order_attach` (`tid`, `gid`, `gnum`, `oid`, `uid`) VALUES
(1, 3, 1, 1, 2),
(2, 3, 1, 2, 2),
(3, 3, 1, 3, 2);
...
CREATE TABLE IF NOT EXISTS `shop` (
  ...
  `gid` int(10) NOT NULL COMMENT '商品ID',
  `nums` int(10) NOT NULL COMMENT '商品数量',
...
INSERT INTO `shop` (`sid`, `gid`, `nums`, `spec`, `uid`) VALUES
(1, 3, 3, '99', 2);
--
-- Database: `home`
--
...
(2, 'dengpeng', '827ccb0eea8a706c4c34a16891f84e7b');
...
CREATE TABLE IF NOT EXISTS `adress` (
  `aid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `atab` varchar(255) NOT NULL DEFAULT 'off' COMMENT '地址分类标签',
  `adress` varchar(255) NOT NULL COMMENT '地址',
  `aname` varchar(255) NOT NULL,
  `atel` varchar(255) NOT NULL,
  `acity` varchar(255) NOT NULL,
...
INSERT INTO `adress` (`aid`, `atab`, `adress`, `aname`, `atel`, `acity`, `rid`) VALUES
(1, 'on', '战狼特战旅', '战狼', '123456789110', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2),
(2, 'off', '军旅之家', '猫头鹰', '123456789110', '山西 / 北京市 / 西城区 / 北新桥街道 / ', 2),
(3, 'off', '凯通大厦', '邓先生', '123456789110', '山西 / 北京市 / 西城区 / 北新桥街道 / ', 2),
(10, 'off', '凯通大厦', '猫头鹰', '23123412', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2),
(9, 'off', '凯通大厦', '张三', '2312418', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2),
(6, 'off', '凯通大厦', '武女士', '12312451251', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2),
(11, 'off', '凯通大厦', '邓鹏', '2312312', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2),
(12, 'off', '凯通大厦', '邓鹏', '2312312', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2),
(13, 'off', '大时代', '等', '3124412451', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2),
(14, 'off', '大时代', '大时代', '21223124', '北京 / 北京市 / 东城区 / 安定门街道 / ', 2);
...
INSERT INTO `manger` (`id`, `username`, `password`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3'),
(2, 'deng', '29aa3379308b1c2bde2b1876186aae49');
...
CREATE TABLE IF NOT EXISTS `orderform` (
  `fid` int(10) NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `rid` int(10) NOT NULL COMMENT '用户ID',
  `status` int(10) NOT NULL DEFAULT '1' COMMENT '订单状态：1待付款2待收货3交易完成',
  `fdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '订单日期',
  `fpro` int(11) NOT NULL COMMENT '订单号',
  PRIMARY KEY (`fid`)
...
INSERT INTO `orderform` (`fid`, `rid`, `status`, `fdate`, `fpro`) VALUES
(1, 2, 1, '2018-02-16 09:14:37', 1518772477),
(2, 2, 1, '2018-02-16 09:45:25', 1518774325),
(3, 2, 1, '2018-02-16 09:45:52', 1518774352),
(4, 2, 1, '2018-02-16 09:50:25', 1518774625),
(5, 2, 1, '2018-02-16 09:51:47', 1518774707),
(6, 2, 1, '2018-02-16 09:52:23', 1518774743),
(7, 2, 1, '2018-02-16 12:31:00', 1518784260),
(8, 2, 1, '2018-02-17 16:15:34', 1518884134),
(9, 2, 1, '2018-02-17 16:16:01', 1518884161),
(10, 2, 1, '2018-02-17 16:17:05', 1518884225),
(11, 2, 1, '2018-02-17 16:18:42', 1518884322),
(12, 2, 1, '2018-02-17 16:19:36', 1518884376),
(13, 2, 1, '2018-02-17 16:19:41', 1518884381),
(14, 2, 1, '2018-02-17 16:20:54', 1518884454),
(15, 2, 1, '2018-02-17 16:29:45', 1518884985),
(16, 2, 1, '2018-02-17 16:30:23', 1518885023),
(17, 2, 1, '2018-02-17 16:30:38', 1518885038),
(18, 2, 1, '2018-02-17 16:31:39', 1518885099),
(19, 2, 1, '2018-02-24 06:33:44', 1519454024),
(20, 2, 1, '2018-02-24 08:37:07', 1519461427),
(21, 2, 1, '2018-02-25 08:29:40', 1519547380),
(22, 2, 1, '2018-02-25 10:30:26', 1519554626),
(23, 2, 1, '2018-02-25 14:43:13', 1519569793),
(24, 2, 1, '2018-02-26 02:18:57', 1519611537),
(25, 2, 1, '2018-02-26 09:29:38', 1519637378),
(26, 2, 1, '2018-02-27 11:00:12', 1519729212),
(27, 2, 1, '2018-02-27 11:04:23', 1519729463),
(28, 2, 1, '2018-02-27 13:21:07', 1519737667);
...
CREATE TABLE IF NOT EXISTS `order_attach` (
  ...
  `gid` int(10) NOT NULL COMMENT '商品ID',
  `totalnum` int(10) NOT NULL COMMENT '商品数量',
  `fid` int(10) NOT NULL COMMENT '所属订单',
  PRIMARY KEY (`oid`)
...
INSERT INTO `order_attach` (`oid`, `gid`, `totalnum`, `fid`) VALUES
(1, 2, 1, 1),
(2, 1, 2, 1),
(3, 2, 1, 2),
(4, 1, 2, 2),
...
(19, 2, 2, 1, '2018-02-08 08:24:32', '1518078272'),
(18, 1, 2, 2, '2018-02-08 08:24:22', '1518078262');
--
-- Database: `users`
--
